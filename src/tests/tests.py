...
class MyTestCase(unittest.TestCase):
    ...
    def test_18_get_piece_positions_invalid_group(self):
    ...
    def test_19_get_piece_position_ok(self):
        board.move_piece(15, (7, 0))
        self.assertEqual((7, 0), board.get_piece_position(15))

    def test_20_get_piece_position_invalid_piece_id(self):
    ...
    def test_23_move_piece_invalid_piece_id(self):
    ...
    def test_26_possible_moves_ok(self):
    ...
    def test_27_possible_moves_invalid_group(self):
    ...
    def test_28_possible_moves_negative_steps(self):
        self.assertEqual(board.NEGATIVE_STEPS, board.get_possible_moves(0, -1))

    def test_29_get_path_ok(self):
    ...
    def test_30_get_path_invalid_position(self):
    ...
    def test_33_move_pieces_to_spawn(self):
        self.assertTrue(board.get_pieces_positions() != board.get_spawn_points())
        board.reset_board()
        self.assertEqual(board.get_spawn_points(), board.get_pieces_positions())

    def help_34_move_one_piece_to_finish(self, piece):
