...
class PieceTest(unittest.TestCase):
    ...
    def test_02_todasPecas(self):
        ...
        self.assertEqual([4,5,6,7],piece.todasPecas(0))
        self.assertEqual([8,9,10,11],piece.todasPecas(0))
        self.assertEqual([12,13,14,15],piece.todasPecas(0))

    def test_03_corPeca(self):
        self.assertEqual((0, 255, 0), piece.corPeca(0))
        self.assertEqual((0, 255, 0), piece.corPeca(1))
        self.assertEqual((0, 255, 0), piece.corPeca(2))
        self.assertEqual((0, 255, 0), piece.corPeca(3))

        self.assertEqual((255, 0, 0), piece.corPeca(4))
        self.assertEqual((255, 0, 0), piece.corPeca(5))
        self.assertEqual((255, 0, 0), piece.corPeca(6))
        self.assertEqual((255, 0, 0), piece.corPeca(7))

        self.assertEqual((0, 0, 255), piece.corPeca(8))
        self.assertEqual((0, 0, 255), piece.corPeca(9))
        self.assertEqual((0, 0, 255), piece.corPeca(10))
        self.assertEqual((0, 0, 255), piece.corPeca(11))

        self.assertEqual((255, 255, 0), piece.corPeca(12))
        self.assertEqual((255, 255, 0), piece.corPeca(13))
        self.assertEqual((255, 255, 0), piece.corPeca(14))
        self.assertEqual((255, 255, 0), piece.corPeca(15))
